...
class ViewController: UIViewController,UIScrollViewDelegate,UIGestureRecognizerDelegate {
    ...
    let topOffset = functionHeaderViewHeight + singleAppHeaderViewHeight
    ...
    lazy var mainScrollView: UIScrollView = {
        ...
        scroll.contentSize = CGSize(width: SCREEN_HEIGHT, height: 100)
    ...
    lazy var navView: UIView = {
        ...
        let view = UIView(frame: CGRect(x: 0, y: 0, width: SCREEN_HEIGHT, height: 64))
    ...
    lazy var mainNavView: UIView = {
        ...
        payButton.titleEdgeInsets = UIEdgeInsets(top: 0, left: 10, bottom: 0, right: 0)
        payButton.sizeToFit()
    ...
    lazy var coverNavView: UIView = {
        ...
        let view = UIView(frame: CGRect(x: 0, y: 0, width: SCREEN_WIDTH, height: 54))
        view.backgroundColor = UIColor.clear
        ...
        searchBtn.setImage(#imageLiteral(resourceName: "camera_mini"), for: UIControlState.normal)
        searchBtn.sizeToFit()
        newFrame.origin.x = newFrame.origin.x + 40 + newFrame.size.width
        searchBtn.frame = newFrame
    ...
    lazy var mainTableView: indexTableView = {
        ...
        let originY = singleAppHeaderViewHeight + functionHeaderViewHeight
        let tableviewHeight = 1000 - originY
        
        let table = indexTableView(frame: CGRect(x: 0, y: originY, width: SCREEN_WIDTH, height: tableviewHeight), style: UITableViewStyle.plain)
        return table
    }()
    ...
    lazy var headerView: UIView = {
        ...
        let view = UIView(frame: CGRect(x: 0, y: 0, width: SCREEN_WIDTH, height: singleAppHeaderViewHeight))
        view.backgroundColor = UIColor(red: 65/255.0, green: 128/255.0, blue: 1, alpha: 1)
    ...
    func updateContentSize(size:CGSize) {
        ...
        contentSize.height = contentSize.height + topOffset
